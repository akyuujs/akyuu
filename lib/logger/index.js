...
Logger.prototype._checkConsoleTransport = function() {
    var consoleTypeFirstIndex = this.transportConfig.findIndex(function(n) {
    ...
    if (consoleTypeFirstIndex === -1) {
        ...
        this.transportConfig.remove(function(n, index) {
...
Logger.prototype.getTransports = function (label) {
    ...
    for(var i = 0; i < this.transportConfig.length; i++) {
        var type = this.transportConfig[i].type.capitalize();
        var transportOption = Object.assign({}, this.transportConfig[i], {
